...
public class GraphicalAgent {
    ...
    public void diceRequest(int playerNumber) throws IOException {
    ...
    public void clickRequest(int x, int y) throws IOException {
    ...
    public void requestStart(int playerNumber) throws IOException {
